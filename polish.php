<?php
/**
 * WHMCS Język Polski DEMO - panel klienta
 * Polish (pl_PL)
 *
 * Skopiować do katalogu domena_z_whmcs/public_html/twoj_folder_jesli_whmcs_w_podfolderze/lang/
 *
 * @package    Hosting5G_Client_Lang_PL
 * @author     SULEMA Sp. z o.o. <info@sulema.pl>
 * @copyright  Copyright (c) SULEMA Sp. z o.o. 20023-2025
 * @version    $Id$
 * @link       https://cp.hosting5g.pl/store/dodatki-do-whmcs/jezyk-polski-panelu-klienta
 */
if (!defined("WHMCS")) die("Do tego pliku nie można uzyskać bezpośredniego dostępu!");

$_LANG['locale'] = "pl_PL";
$_LANG['aboutsecurityquestions'] = "Dlaczego pytania bezpieczeństwa?";
$_LANG['accessdenied'] = "Odmowa dostępu";
$_LANG['account'] = "Konto";
$_LANG['accountInvite']['accept'] = "Akceptuj zaproszenie";
$_LANG['accountInvite']['acceptSuccess'] = "Zaproszenie do konta zostało przyjęte!";
$_LANG['accountInvite']['contactAdministrator'] = "Skontaktuj się z administratorem konta, aby poprosić o nowe zaproszenie.";
$_LANG['accountInvite']['emailAlreadyExists'] = "Istnieje już użytkownik z tym adresem e-mail. Zaloguj się lub użyj innego adresu e-mail.";
$_LANG['accountInvite']['givenAccess'] = ":ot:senderName:ct przyznał Ci dostęp do konta :ot:clientName:ct.";
$_LANG['accountInvite']['inviteAcceptLoggedIn'] = "Aby zaakceptować zaproszenie, kliknij poniższy przycisk.";
$_LANG['accountInvite']['inviteAcceptLoggedOut'] = "Aby zaakceptować zaproszenie, zaloguj się lub zarejestruj poniżej.";
$_LANG['accountInvite']['notFound'] = "Przepraszamy, nie znaleźliśmy oczekującego zaproszenia odpowiadającego Twojej prośbie.";
$_LANG['accountInvite']['title'] = "Akceptuj zaproszenie";
$_LANG['accountInvite']['userAlreadyAssociated'] = "Twoje konto użytkownika jest już powiązane z docelowym kontem zaproszenia.";
$_LANG['accountInvite']['youHaveBeenInvited'] = "Zostałeś zaproszony do :clientName";
$_LANG['accountinfo'] = "Informacje o koncie";
$_LANG['accountoverview'] = "Przegląd konta";
$_LANG['accountstats'] = "Statystyki konta";
$_LANG['actionRequiresAtLeastOneDomainSelected'] = "Wybierz co najmniej jedną domenę, aby wykonać wybraną akcję.";
$_LANG['actions'] = "Akcje";
$_LANG['activateNowFor'] = "Aktywuj teraz za :price";
$_LANG['addfunds'] = "Dodaj środki";
$_LANG['addfundsamount'] = "Kwota do dodania";
$_LANG['addfundsdescription'] = "Dodaj środki do swojego konta u nas, aby uniknąć wielu małych transakcji i automatycznie obsługiwać wszystkie nowe faktury, które zostaną wygenerowane.";
$_LANG['addfundsintro'] = "Wpłać pieniądze z góry";
$_LANG['addfundsmaximum'] = "Maksymalny depozyt";
$_LANG['addfundsmaximumbalance'] = "Maksymalne saldo";
$_LANG['addfundsmaximumbalanceerror'] = "Maksymalna kwota salda to";
$_LANG['addfundsmaximumerror'] = "Maksymalna kwota depozytu to";
$_LANG['addfundsminimum'] = "Minimalny depozyt";
$_LANG['addfundsminimumerror'] = "Minimalna kwota depozytu to";
$_LANG['addfundsnonrefundable'] = "* Wszystkie depozyty są bezzwrotne.";
$_LANG['additionalInfo'] = "Dodatkowe informacje";
$_LANG['addmore'] = "Dodaj więcej";
$_LANG['addonsExtras'] = "Dodatki i dodatki";
$_LANG['addtocart'] = "Dodaj do koszyka";
$_LANG['admin']['returnToAdmin'] = "Powrót do panelu administracyjnego";
$_LANG['adminloggedin'] = "Jesteś zalogowany jako administrator.";
$_LANG['adminmasqueradingasclient'] = "Używasz obecnie pseudonimu klienta.";
$_LANG['affiliateWithdrawalSummary'] = "Będziesz mógł zlecić wypłatę, gdy saldo osiągnie minimalną wymaganą kwotę :amountForWithdrawal.";
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "Twoja prośba o wypłatę nie powiodła się. Spróbuj ponownie później.";
$_LANG['affiliatesactivate'] = "Aktywuj konto partnerskie";
$_LANG['affiliatesamount'] = "Kwota";
$_LANG['affiliatesbalance'] = "Aktualne saldo";
$_LANG['affiliatesbullet1'] = "Otrzymaj początkowy bonus w wysokości";
$_LANG['affiliatesbullet2'] = "od każdej płatności dokonanej przez każdego klienta, którego nam polecisz, przez cały okres obowiązywania jego konta hostingowego";
$_LANG['affiliatesclicks'] = "Kliknięcia";
$_LANG['affiliatescommission'] = "Prowizja";
$_LANG['affiliatescommissionsavailable'] = "Dostępne saldo prowizji";
$_LANG['affiliatescommissionspending'] = "Prowizje oczekujące na zatwierdzenie";
$_LANG['affiliatesconversionrate'] = "Konwersje";
$_LANG['affiliatesdescription'] = "Dołącz do naszego programu partnerskiego lub sprawdź zarobki";
$_LANG['affiliatesdisabled'] = "Obecnie nie oferujemy naszym klientom systemu partnerskiego.";
$_LANG['affiliatesearn'] = "Zarób";
$_LANG['affiliatesearningstodate'] = "Całkowite zarobki do tej pory";
$_LANG['affiliatesfootertext'] = "Kiedy polecasz komuś naszą stronę internetową za pomocą swojego unikalnego identyfikatora polecającego, na jego komputerze umieszczany jest plik cookie zawierający ten identyfikator, dzięki czemu jeśli doda on stronę do zakładek i wróci później, nadal otrzymasz prowizję.";
$_LANG['affiliateshostingpackage'] = "Pakiet hostingowy";
$_LANG['affiliatesignupinfo1'] = "Wypłacamy prowizje za każdą rejestrację, która nastąpi za pośrednictwem Twojego spersonalizowanego linku rejestracyjnego.";
$_LANG['affiliatesignupinfo2'] = "Śledzimy odwiedzających, których nam polecisz, za pomocą plików cookie, dzięki czemu poleceni przez Ciebie użytkownicy nie muszą od razu dokonywać zakupu, abyś otrzymał prowizję. Pliki cookie są ważne do 90 dni od pierwszej wizyty.";
$_LANG['affiliatesignupinfo3'] = "Aby dowiedzieć się więcej, skontaktuj się z nami. ";
$_LANG['affiliatesignupintro'] = "Aktywuj swoje konto partnerskie i zacznij zarabiać już dziś...";
$_LANG['affiliatesignuptitle'] = "Zarabiaj na polecaniu nam klientów";
$_LANG['affiliatesinitialthen'] = "Na początek, a następnie";
$_LANG['affiliatesintrotext'] = "Aktywuj swoje konto partnerskie już dziś, aby:";
$_LANG['affiliateslinktous'] = "Połączyć się z nami";
$_LANG['affiliatesnosignups'] = "Aktualnie nie otrzymałeś żadnych rejestracji";
$_LANG['affiliatesrealtime'] = "Statystyki są aktualizowane w czasie rzeczywistym i aktualizują się natychmiast";
$_LANG['affiliatesreferallink'] = "Twój unikalny link polecający";
$_LANG['affiliatesreferals'] = "Twoi poleceni";
$_LANG['affiliatesregdate'] = "Data rejestracji";
$_LANG['affiliatesrequestwithdrawal'] = "Wniosek o wypłatę";
$_LANG['affiliatessignupdate'] = "Data rejestracji";
$_LANG['affiliatessignups'] = "Rejestracje";
$_LANG['affiliatesstatus'] = "Status";
$_LANG['affiliatestitle'] = "Partnerzy";
$_LANG['affiliatesvisitorsreferred'] = "Liczba poleconych użytkowników";
$_LANG['affiliateswithdrawalrequestsuccessful'] = "Twój wniosek o wypłatę został wysłany. Wkrótce się z Tobą skontaktujemy.";
$_LANG['affiliateswithdrawn'] = "Całkowita wypłacona kwota";
$_LANG['ajaxcartcheckout'] = "Przejdź bezpośrednio do kasy &raquo;";
$_LANG['ajaxcartconfigreqnotice'] = "Jesteś na dobrej drodze do rejestracji, ale musisz wybrać domenę, zanim dodasz wybrany produkt do koszyka...";
$_LANG['all'] = "Wszystkie";
$_LANG['allrightsreserved'] = "Wszelkie prawa zastrzeżone";
$_LANG['allthelatest'] = "Wszystkie najnowsze informacje";
$_LANG['alltldpricing'] = "Ceny wszystkich domen najwyższego poziomu";
$_LANG['almostDone'] = "Prawie gotowe";
$_LANG['alreadyregistered'] = "Zarejestrowany?";
$_LANG['alreadyunsubscribed'] = "Zrezygnowałeś już z subskrypcji naszego newslettera. ";
$_LANG['announcementsbymonth'] = "Według miesiąca";
$_LANG['announcementschoosemonth'] = "Wybierz miesiąc";
$_LANG['announcementscontinue'] = "Czytaj dalej";
$_LANG['announcementsdescription'] = "Zobacz nasze najnowsze wiadomości i ogłoszenia";
$_LANG['announcementsnone'] = "Brak ogłoszeń do wyświetlenia";
$_LANG['announcementsolder'] = "Starsze ogłoszenia";
$_LANG['announcementsrss'] = "Wyświetl kanał RSS";
$_LANG['announcementstitle'] = "Ogłoszenia";
$_LANG['api']['client']['countryError'] = "Wymagany prawidłowy kraj";
$_LANG['apply'] = "Zastosuj";
$_LANG['assignedIPs'] = "Przypisane adresy IP";
$_LANG['availcreditbal'] = "Dostępne saldo kredytowe";
$_LANG['availcreditbaldesc'] = "Posiadasz saldo kredytowe w wysokości %s, które zostanie automatycznie doliczone do wszystkich nowych faktur";
$_LANG['back'] = "Wstecz";
$_LANG['backtodomainslist'] = "&laquo; Powrót do listy domen";
$_LANG['backtoservicedetails'] = "Powrót do szczegółów usługi";
$_LANG['backtoserviceslist'] = "&laquo; Powrót do listy usług";
$_LANG['balancedue'] = "Należność";
$_LANG['bandwidth'] = "Przepustowość";
$_LANG['bandwidthUsage'] = "Wykorzystanie przepustowości";
$_LANG['bankPaymentDeclined'] = "Podane dane konta bankowego zostały odrzucone. Spróbuj użyć innego konta lub skontaktuj się z pomocą techniczną.";
$_LANG['bannedbanexpires'] = "Wygasa blokada";
$_LANG['bannedbanreason'] = "Powód blokady";
$_LANG['bannedhasbeenbanned'] = "został zablokowany";
$_LANG['bannedtitle'] = "Zablokowany adres IP";
$_LANG['bannedyourip'] = "Twój adres IP";
$_LANG['billableitemseach'] = "Każdy";
$_LANG['billableitemshour'] = "Godzina";
$_LANG['billableitemshours'] = "Godziny";
$_LANG['billableitemsquantity'] = "Ilość";
$_LANG['billingAddress'] = "Adres rozliczeniowy";
$_LANG['billingOverview'] = "Przegląd rozliczeń";
$_LANG['billingdetails'] = "Szczegóły rozliczeń";
$_LANG['blankCustomField'] = "(brak wartości)";
$_LANG['browseProducts'] = "Przeglądaj produkty";
$_LANG['bulkoptions'] = "Opcje hurtowe";
$_LANG['bundledeal'] = "Oferta pakietowa!";
$_LANG['bundlemaxusesreached'] = "Pakiet niedostępny";
$_LANG['bundlemaxusesreacheddesc'] = "Ta oferta pakietowa osiągnęła maksymalną dozwoloną liczbę użyć i niestety nie jest już dostępna. Skontaktuj się z nami, jeśli jesteś zainteresowany naszymi usługami, aby omówić tę kwestię.";
$_LANG['bundlereqsnotmet'] = "Wymagania dotyczące pakietu nie zostały spełnione";
$_LANG['bundlevaliddateserror'] = "Pakiet niedostępny";
$_LANG['bundlevaliddateserrordesc'] = "Ten pakiet nie jest jeszcze aktywny lub wygasł. Jeśli uważasz, że ta wiadomość to błąd, skontaktuj się z pomocą techniczną. ";
$_LANG['bundlewarningdomainaddon'] = "Wybrany pakiet wymaga wybrania dodatku „%s” dla domeny %s, aby się zakwalifikować.";
...
$_LANG['bundlewarningdomainreq'] = "Wybrany pakiet wymaga zarejestrowania lub przeniesienia domeny z produktem %s, aby się zakwalifikować.";
$_LANG['bundlewarningdomaintld'] = "Wybrany pakiet wymaga wybrania domeny z rozszerzeniem „%s” dla domeny %s, aby się zakwalifikować.";
$_LANG['bundlewarningproductaddonreq'] = "Wybrany pakiet wymaga wybrania dodatku „%s” dla produktu %s, aby się zakwalifikować.";
$_LANG['bundlewarningproductconfopqtyreq'] = "Wybrany pakiet wymaga wybrania ilości „%s” dla „%s”, aby się zakwalifikować.";
...
$_LANG['bundlewarningproductcycle'] = "Wybrany pakiet wymaga wybrania cyklu rozliczeniowego „%s”, aby się zakwalifikować.";
$_LANG['bundlewarningpromo'] = "Wybranego pakietu nie można łączyć z innymi promocjami ani ofertami.";
$_LANG['buy'] = "Kup";
$_LANG['buyadomain'] = "Kup Domenę";
$_LANG['cPanel']['autoresponders'] = "Autorespondery";
$_LANG['cPanel']['awstats'] = "Awstats";
$_LANG['cPanel']['backup'] = "Kopia zapasowa";
$_LANG['cPanel']['create'] = "Utwórz";
$_LANG['cPanel']['createEmailAccount'] = "Szybkie tworzenie konta e-mail";
$_LANG['cPanel']['cronJobs'] = "Zadania cron";
$_LANG['cPanel']['domains'] = "Domeny";
$_LANG['cPanel']['emailAccountCreateFailed'] = "Nieudane utworzenie konta e-mail:";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "Konto e-mail zostało pomyślnie utworzone!";
$_LANG['cPanel']['emailAccounts'] = "Konta e-mail";
$_LANG['cPanel']['forwarders'] = "Przekierowania";
$_LANG['cPanel']['packageNotActive'] = "Ten pakiet hostingowy jest obecnie";
$_LANG['cPanel']['passwordPlaceholder'] = "Żądane hasło";
$_LANG['cPanel']['phpMyAdmin'] = "phpMyAdmin";
$_LANG['cPanel']['statusPendingNotice'] = "Nie możesz rozpocząć korzystania z tego konta hostingowego, dopóki nie zostanie ono aktywowane.";
$_LANG['cPanel']['statusSuspendedNotice'] = "Nie możesz kontynuować korzystania z tego pakietu ani nim zarządzać, dopóki nie zostanie on ponownie aktywowany.";
$_LANG['cPanel']['usernamePlaceholder'] = "Twoja nazwa";
$_LANG['cPanel']['wptk'] = "WP Toolkit";
$_LANG['cancel'] = "Anuluj";
$_LANG['cancellationrequested'] = "Żądanie anulowania";
$_LANG['cancellationrequestedexplanation'] = "Istnieje oczekujące żądanie anulowania dla tego produktu/usługi";
$_LANG['cancelrequestdomain'] = "Anulować odnowienie domeny?";
$_LANG['cancelrequestdomainconfirm'] = "Potwierdzam, że nie chcę ponownie odnawiać tej domeny";
$_LANG['cancelrequestdomaindesc'] = "Masz również aktywną rejestrację domeny powiązanej z tym produktem<br />Ta domena ma zostać odnowiona %s za kwotę %s na %s lat<br /><br />Jeśli chcesz również anulować domenę i pozwolić jej wygasnąć po zakończeniu bieżącej rejestracji, zaznacz poniższe pole. ";
$_LANG['captcha']['hcaptcha']['disclaimer'] = "Ta witryna jest chroniona przez hCaptcha® i obowiązują jej <a href=\":privacyUrl\">Polityka prywatności</a> oraz <a href=\":termsUrl\">Warunki korzystania z usługi</a>.";
$_LANG['captcha']['hcaptcha']['tagLine'] = "Chronione przez hCaptcha®";
$_LANG['captcha']['verification']['failed'] = "Weryfikacja captcha nie powiodła się. Skontaktuj się z pomocą techniczną, aby uzyskać więcej informacji.";
$_LANG['captchaIncorrect'] = "Uzupełnij captcha i spróbuj ponownie.";
$_LANG['captchatitle'] = "Weryfikacja botów spamujących";
$_LANG['captchaverify'] = "Wpisz znaki widoczne na poniższym obrazku w odpowiednim polu tekstowym. Jest to wymagane, aby zapobiec automatycznemu przesyłaniu.";
$_LANG['captchaverifyincorrect'] = "Wprowadzone znaki nie pasują do wyświetlanego obrazka. Spróbuj ponownie.";
$_LANG['cart']['applyCreditAmount'] = "Zastosuj <span>:amount</span> z mojego salda kredytowego do tego zamówienia, a pozostałą kwotę zapłacę wybraną poniżej metodą płatności.";
$_LANG['cart']['applyCreditAmountNoFurtherPayment'] = "Zastosuj <span>:amount</span> z mojego salda kredytowego do tego zamówienia. Nie będzie należna żadna dodatkowa płatność.";
$_LANG['cart']['applyCreditSkip'] = "Nie stosuj żadnych środków z mojego salda kredytowego do tego zamówienia. Zapłacę za nie wybraną poniżej metodą płatności.";
$_LANG['cart']['availableCreditBalance'] = "Dostępne saldo kredytowe wynosi :amount.";
$_LANG['cart']['idnLanguage'] = "Wybierz język IDN";
$_LANG['cart']['idnLanguageDescription'] = "Wykryliśmy, że wprowadzona domena jest międzynarodową nazwą domeny. Aby kontynuować, wybierz żądany język domeny.";
$_LANG['cart']['selectIdnLanguageForRegister'] = "Wybierz język domeny, którą chcesz zarejestrować.";
$_LANG['cartSimpleCaptcha'] = "Wprowadź kod widoczny poniżej";
$_LANG['cartaddandcheckout'] = "Dodaj do koszyka i przejdź do kasy";
$_LANG['cartaddons'] = "Dodatki";
$_LANG['cartapifailedtoloadcart'] = "System nie mógł załadować żądanego koszyka. <strong><a href=\"cart.php\">Kliknij tutaj</a></strong>, aby rozpocząć nowe zamówienie.";
$_LANG['cartavailableaddons'] = "Dostępne dodatki";
$_LANG['cartbrowse'] = "Przeglądaj produkty i usługi";
$_LANG['cartchooseanothercategory'] = "Wybierz inną kategorię";
$_LANG['cartchooseanotherproduct'] = "Wybierz inny produkt";
$_LANG['cartchoosecycle'] = "Wybierz cykl rozliczeniowy";
$_LANG['cartchooseproduct'] = "Wybierz produkt";
$_LANG['cartconfigdomainextras'] = "Skonfiguruj dodatki do domeny";
$_LANG['cartconfigoptionsdesc'] = "Ten produkt/usługa oferuje kilka opcji, które możesz wybrać poniżej, aby spersonalizować swoje zamówienie.";
$_LANG['cartconfigserver'] = "Skonfiguruj serwer";
$_LANG['cartconfigurationoptions'] = "Opcje konfiguracji";
$_LANG['cartcongratsdomainavailable'] = "Gratulacje, %s jest dostępny!";
$_LANG['cartcustomfieldsdesc'] = "Ten produkt/usługa wymaga od Ciebie dodatkowych informacji, abyśmy mogli przetworzyć Twoje zamówienie.";
$_LANG['cartdomainavailablemanual'] = "Zarejestruję go osobno";
$_LANG['cartdomainavailableoptions'] = "Gratulacje, ta domena jest dostępna!";
$_LANG['cartdomainavailableregister'] = "Zarejestruj tę domenę.";
$_LANG['cartdomainexists'] = "Ta domena już istnieje w naszej bazie danych, więc nie można jej ponownie zamówić.";
$_LANG['cartdomaininvalid'] = "Wprowadzona domena jest nieprawidłowa. Wprowadź tylko część po www. i uwzględnij domenę najwyższego poziomu (TLD).";
$_LANG['cartdomainsconfig'] = "Konfiguracja domen";
$_LANG['cartdomainsconfigdesc'] = "Poniżej możesz skonfigurować nazwy domen w koszyku, wybierając usługi dodatkowe, podając wymagane informacje i definiując serwery nazw, z których będą korzystać.";
$_LANG['cartdomainsconfiginfo'] = "Poniższe opcje i ustawienia są dostępne dla wybranych domen. Pola wymagane są oznaczone *.";
$_LANG['cartdomainshashosting'] = "Posiada hosting";
$_LANG['cartdomainsnohosting'] = "Brak hostingu! Kliknij, aby dodać";
$_LANG['cartdomaintaken'] = "Przepraszamy, domena %s jest już zajęta";
$_LANG['cartdomainunavailablemanual'] = "Jestem już właścicielem tej domeny i zaktualizuję serwery nazw";
$_LANG['cartdomainunavailableoptions'] = "Przepraszamy, ta domena jest już zajęta. Jeśli jesteś właścicielem, wybierz opcję poniżej...";
$_LANG['cartdomainunavailabletransfer'] = "Przenieś moją domenę";
$_LANG['carteditproductconfig'] = "Edytuj konfigurację";
$_LANG['cartempty'] = "Twój koszyk jest pusty";
$_LANG['cartemptyconfirm'] = "Czy na pewno chcesz opróżnić koszyk?";
$_LANG['cartenterdomain'] = "Wprowadź poniżej domenę, której chcesz użyć.";
$_LANG['cartenterpromo'] = "Wprowadź kod promocyjny";
$_LANG['carterrordomainconfigskipped'] = "Musisz wrócić i wypełnić powyższe pola konfiguracji domeny";
$_LANG['cartexistingclientlogin'] = "Logowanie istniejącego klienta";
$_LANG['cartexistingclientlogindesc'] = "Aby dodać to zamówienie do istniejącego konta, musisz się zalogować poniżej.";
$_LANG['cartexistingcustomer'] = "Jestem istniejącym klientem";
$_LANG['cartexistingdomainchoice'] = "Użyję istniejącej domeny i zaktualizuję serwery nazw";
$_LANG['cartfollowingaddonsavailable'] = "Poniższe dodatki są dostępne dla Twoich aktywnych produktów i usług. ";
$_LANG['cartfraudcheck'] = "Weryfikacja oszustw";
$_LANG['cartmakedomainselection'] = "Podaj nam domenę, której chcesz używać z usługą hostingową, wybierając jedną z poniższych opcji.";
$_LANG['cartnameserverchoice'] = "Wybór serwera nazw";
$_LANG['cartnameserverchoicecustom'] = "Użyj niestandardowych serwerów nazw";
$_LANG['cartnameserverchoicedefault'] = "Użyj domyślnych serwerów nazw dla naszego hostingu";
